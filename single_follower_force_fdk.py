...
------!!!------
NOV 1, 2021
the thrust controller of the followers is in a feedback manner, 
the data are logged back from the robot, which is unprecise and has delay

the modified firmware of the followers can send the thrust commnad in NEWTON 
directly in Python 

so this progrome is less useful
"""
...
def crazyflie_control(scf, control_which_flag):
    ...
    desired_x_leader = 0.85
    desired_y_leader = 0.56
    desired_z_leader = 0.03
    desired_yaw_leader = 0.0

    desired_x_follower = 0.90
    desired_y_follower = -0.66
    ...
    thrust_error_inNewton_prev = 0.0
    ...
    # follower flight control branch            
        ...
        with SyncLogger(scf, lg_stab_follower_1) as logger_follower_1:
            ...
            for log_entry in logger_follower_1:
                ...
                # rigid body ID of the leader from the MoCap
                dp_leader.step(data[(rigid_body_ID_leader-1)*14 : rigid_body_ID_leader*14])
                ...
                if take_off_flag_follower and not land_flag_follower:
                    ...
                    # if not position_control_flag:
                        ...
                        thrust_p_term = thrust_p_gain*thrust_error_inNewton
                        thrust_d_term = thrust_d_gain*(thrust_error_inNewton - thrust_error_inNewton_prev)
                        thrust_error_inNewton_prev = thrust_error_inNewton
                        thrust_cmd = int(thrust_cmd + thrust_p_term + thrust_d_term)
                        #Thrust_fcmd = P*thrust_error + thrust_cmd + c0
                        ...
                        if time_index % 50 == 0:
                            print('position_control_off', time_index/50, 'sec', ' ,thrust_cmd=', thrust_cmd,
...
if __name__ == '__main__':
    ...
    saver_follower_1 = savemat.DataSaver('roll_actual', 'pitch_actual', 'thrust_actual', 
        ...
        'X_pos_payload', 'Y_pos_payload', 'Z_pos_payload')
    ...
    saver_follower_1.save2mat('DATA_single_follower/')
