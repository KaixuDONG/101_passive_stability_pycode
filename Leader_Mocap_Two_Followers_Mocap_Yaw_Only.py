...
all the robots require the information from mocap, in which
-> the leader is controlled by Mocap
-> the yaw motion of two followers is contorlled by the Mocap

!!!! ---- CAUTION ---- !!!! 
the firmware of the followers are modified that the 
sendsetpoint gives the thrust in NEWTON directly

the version 1.0 is finished by Estel in OCT 12, 2021


NOV 1, 2021
!!!--------------
this is the most recent version for passive stability cooperative transporting for three robots

NOV 3, 2021
!!!------------
the data recording error has been solved, by using different threads for the UDP receiver

NOV 10， 2021
！！！————————
the taking off procedure should be paid special attention
        ...
        with SyncLogger(scf, lg_stab_follower_1) as logger_followrer_1:
            ...
            for log_entry in logger_followrer_1:
                ...
                if follower_1.take_off_flag and not follower_1.land_flag:
                    ...
                    if current_time_follower_1 <= 6:
                        time_scale_follower_1 = current_time_follower_1/6
                        desired_thrust_inNewton_temp_follower_1 = time_scale_follower_1*0.9*follower_1.thrust_inNewton.des
                        desired_roll_temp_follower_1 =  time_scale_follower_1 * 2
                        desired_pitch_temp_follower_1 = time_scale_follower_1 * 2                   
                    ...
                    elif current_time_follower_1 <= 8:                       
                    ...
                    elif current_time_follower_1 <= 10:                       
        ...
        with SyncLogger(scf, lg_stab_follower_2) as logger_followrer_2:
            ...
            for log_entry in logger_followrer_2:
                ...
                if follower_2.take_off_flag and not follower_2.land_flag:
                    ...
                    if current_time_follower_2 <= 6:
                        time_scale_follower_2 = current_time_follower_2/6
                        desired_thrust_inNewton_temp_follower_2 = time_scale_follower_2 * 0.7 * follower_2.thrust_inNewton.des
                        desired_roll_temp_follower_2 = time_scale_follower_2 * 2
                        desired_pitch_temp_follower_2 = time_scale_follower_2 * 2            
                    ...
                    elif current_time_follower_2 <= 10:                       
...
if __name__ == '__main__':
    ...
    leader.pos_x.des = 0.3
    leader.pos_y.des = 0.77
    leader.pos_z.des = 0.15

    follower_1.yaw.des = 0.0
    follower_2.yaw.des = 0.0

    varying_formation_flag = True
    ...
    time.sleep(3)
    saver_follower_1.save2mat('DATA_Leader_Mocap_Two_Followers_Passive/')
